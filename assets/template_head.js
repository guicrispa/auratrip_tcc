// tag do span #head em uma variável
let head=document.getElementById('head')[0];

// tag

head.insertAdjacentHTML('afterend', `<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="icon" href="assets/iconpngauratrip.png">
